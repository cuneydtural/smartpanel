...
@section('css')
        ...
        <div class="page-header-content">
            ...
            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{ route('admin.roles.create') }}" class="btn btn-link btn-float has-text"><i class="icon-plus3 text-primary"></i><span>Yeni Rol Ekle</span></a>
                </div>
            </div>
        </div>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.roles.show', ['sort' => 'list']) }}"><i class="icon-sort-numeric-asc"></i> Sıralamaya Göre</a></li>
                        <li><a href="{{ route('admin.roles.show', ['sort' => 'desc']) }}"><i class="icon-sort"></i> ID'ye göre</a></li>
                        <li><a href="{{ route('admin.roles.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Aktifler</a></li>
                        <li><a href="{{ route('admin.roles.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Pasifler</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.roles.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Rol Listesi</h5>
            <div class="heading-elements">
                <ul class="icons-list">
    ...
    <script>
        ...
        $(".datatable-responsive").on("click", ".confirm-btn", function (e) {
            ...
            bootbox.confirm("(<strong>" + title + "</strong>) rolü siliniyor. Onaylıyor musunuz ?", function (result) {
                if (result == true) {
                    $.ajax({
                        url: url,
                        data: {_token: token},
        ...
        $(function () {
            ...
            $('#datatable-form').submit(function () {
                ...
                $.ajax({
                    url: '{{ route('admin.roles.multiple') }}',
        ...
        @if(Session::has('sort') && Session::get('sort') == 'list')
            ...
            $("tbody").sortable({
                opacity: 0.8, cursor: 'move', update: function () {
                    ...
                    $.get("{{ route('admin.roles.show', ['sort' => 'sort']) }}", order, function (response) {

    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Aboneler</span> /
                    Abone Listesi</h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{ route('admin.subscribers.create') }}" class="btn btn-link btn-float has-text"><i
                                class="icon-plus3 text-primary"></i><span>Yeni Abone Ekle</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component bg-grey">
            <ul class="breadcrumb">
                ...
                <li><a href="">Aboneler</a></li>
                <li class="active">Abone Listesi</li>
            </ul>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.subscribers.show', ['sort' => 'list']) }}"><i class="icon-sort-numeric-asc"></i> Sıralamaya Göre</a></li>
                        <li><a href="{{ route('admin.subscribers.show', ['sort' => 'desc']) }}"><i class="icon-sort"></i> ID'ye göre</a></li>
                        <li><a href="{{ route('admin.subscribers.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Aktifler</a></li>
                        <li><a href="{{ route('admin.subscribers.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Pasifler</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.subscribers.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    @if(Session::has('sort') && Session::get('sort') == 'list')
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Abone Listesi</h5>
                <div class="heading-elements">
                    <ul class="icons-list">
        ...
        <script>
            ...
            $(".datatable-responsive").on("click", ".confirm-btn", function (e) {
                ...
                bootbox.confirm("(<strong>" + title + "</strong>) isimli abone siliniyor. Onaylıyor musunuz ?", function (result) {
                    if (result == true) {
                        $.ajax({
                            url: url,
                            data: {_token: token},
            ...
            @if(Session::has('sort') && Session::get('sort') == 'list')
                ...
                $("tbody").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.get("{{ route('admin.subscribers.show', ['sort' => 'sort']) }}", order, function (response) {

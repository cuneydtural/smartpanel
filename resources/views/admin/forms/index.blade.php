            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.forms.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Cevaplananlar</a></li>
                        <li><a href="{{ route('admin.forms.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Cevaplanmayanlar</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.forms.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    @if(Session::has('sort') && Session::get('sort') == 'list')
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Form Listesi</h5>
                    ...
                    <div class="pull-left margin-right-10 action-selectbox">
                        <select class="select" name="action">
                            <optgroup label="Toplu işlemler ">
                                ...
                                <option value="active">Seçili öğeler cevaplandı</option>
                                <option value="passive">Seçili öğeleri cevaplanmadı</option>
        ...
        <script>
            $(function () {
                $('.datatable-responsive').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'types', name: 'type', orderable: true, searchable: true, exportable: true},
            ...
            $(function () {
                ...
                $('#datatable-form').submit(function () {
                    ...
                    $.ajax({
                        url: '{{ route('admin.forms.multiple') }}',
            ...
            @if(Session::has('sort') && Session::get('sort') == 'list')
                ...
                $("tbody").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.get("{{ route('admin.forms.show', ['sort' => 'sort']) }}", order, function (response) {

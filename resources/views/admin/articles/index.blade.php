...
@section('css')
    ...
    <div class="page-header">
        ...
        <div class="breadcrumb-line breadcrumb-line-component bg-grey">
            <ul class="breadcrumb">
                ...
                <li class="active">Yazı Listesi</li>
            </ul>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.articles.show', ['sort' => 'list']) }}"><i class="icon-sort-numeric-asc"></i> Sıralamaya Göre</a></li>
                        <li><a href="{{ route('admin.articles.show', ['sort' => 'desc']) }}"><i class="icon-sort"></i> ID'ye göre</a></li>
                        <li><a href="{{ route('admin.articles.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Aktifler</a></li>
                        <li><a href="{{ route('admin.articles.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Pasifler</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.articles.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">Yazı Listesi</h5>
            <div class="heading-elements">
                <ul class="icons-list">
    ...
    <script>
        $(function () {
            $('.datatable-responsive').DataTable({
                ...
                columns: [
                    ...
                    {data: 'title', name: 'title', orderable: true, searchable: true, exportable: true},
                    {data: 'categories', name: 'title', orderable: true, searchable: true, exportable: true},
        ...
        $(function () {
            ...
            $('#datatable-form').submit(function () {
                ...
                $.ajax({
                    url: '{{ route('admin.articles.multiple') }}',

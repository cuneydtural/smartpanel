            ...
            <div class="category-content no-padding">
                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li>
                        ...
                        <ul>
                            <li @if(Request::segment(3)=="users") class="active" @endif><a href="{{ route('admin.users.index') }}" id="layout1">Kullanıcılar</a></li>
                            <li @if(Request::segment(3)=="roles") class="active" @endif><a href="{{ route('admin.roles.index') }}" id="layout1">Yetki Grupları</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="icon-cart2"></i> <span>Ürün Yönetimi</span></a>
                        <ul>
                            <li @if(Request::segment(3)=="products") class="active" @endif><a href=" {{ route('admin.products.index') }} " id="layout1">Ürün Listeleri</a></li>
                            <li @if(Request::segment(3)=="campaigns") class="active" @endif><a href=" {{ route('admin.campaigns.index') }} " id="layout1">Kampanyalar</a></li>
                        </ul>
                    </li>

    ...
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{ route('admin.slides.create') }}" class="btn btn-link btn-float has-text"><i class="icon-plus3 text-primary"></i><span>Yeni Slide Ekle</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component bg-grey">
            <ul class="breadcrumb">
                ...
                <li class="active">Slide Listesi</li>
            </ul>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.slides.show', ['sort' => 'list']) }}"><i class="icon-sort-numeric-asc"></i> Sıralamaya Göre</a></li>
                        <li><a href="{{ route('admin.slides.show', ['sort' => 'desc']) }}"><i class="icon-sort"></i> ID'ye göre</a></li>
                        <li><a href="{{ route('admin.slides.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Aktifler</a></li>
                        <li><a href="{{ route('admin.slides.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Pasifler</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.slides.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    @if(Session::has('sort') && Session::get('sort') == 'list')
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Slide Listesi</h5>
                <div class="heading-elements">
                    <ul class="icons-list">
            ...
            <table class="table datatable-responsive table-striped">
                <thead>
                <tr>
                    <th width="50"><input value="1" type="checkbox" id="select-all"></th>
                    <th width="60">Id</th>
        ...
        <script>
            ...
            $(function () {
                ...
                $('#datatable-form').submit(function () {
                    ...
                    $.ajax({
                        url: '{{ route('admin.slides.multiple') }}',
            ...
            @if(Session::has('sort') && Session::get('sort') == 'list')
                ...
                $("tbody").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.get("{{ route('admin.slides.show', ['sort' => 'sort']) }}", order, function (response) {

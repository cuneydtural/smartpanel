    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Şubeler</span> /
                    Şube Listesi</h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{ route('admin.stores.create') }}" class="btn btn-link btn-float has-text"><i class="icon-plus3 text-primary"></i><span>Şube Ekle</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component bg-grey">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('admin.stores.index') }}">Şubeler</a></li>
                <li class="active">Şube Listesi</li>
            </ul>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.stores.show', ['sort' => 3]) }}"><i class="icon-arrow-right8"></i> Servisler</a></li>
                        <li><a href="{{ route('admin.stores.show', ['sort' => 1]) }}"><i class="icon-arrow-right8"></i> Satış Noktalarımız</a></li>
                        <li><a href="{{ route('admin.stores.show', ['sort' => 2]) }}"><i class="icon-arrow-right8"></i> Gazete Dağıtım Noktalarımız</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.stores.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    @if(Session::has('sort') && Session::get('sort') == 'list')
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title">Şube Listesi</h5>
                <div class="heading-elements">
                    <ul class="icons-list">
        ...
        <script>
            $(function () {
                $('.datatable-responsive').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'category', name: 'id', orderable: true, searchable: true, exportable: true},
            ...
            $(function () {
                ...
                $('#datatable-form').submit(function () {
                    ...
                    $.ajax({
                        url: '{{ route('admin.stores.multiple') }}',
            ...
            @if(Session::has('sort') && Session::get('sort') == 'list')
                ...
                $("tbody").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.get("{{ route('admin.stores.show', ['sort' => 'sort']) }}", order, function (response) {

    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Ürünler</span> /
                    Ürün Listesi</h4>
            </div>

            <div class="heading-elements">
                <div class="heading-btn-group">
                    <a href="{{ route('admin.products.create') }}" class="btn btn-link btn-float has-text"><i class="icon-plus3 text-primary"></i><span>Ürün Ekle</span></a>
                </div>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-component bg-grey">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('admin.stores.index') }}">Ürünler</a></li>
            ...
            <ul class="breadcrumb-elements">
                <li class="dropdown">
                    ...
                    <!-- Stores modelindeki Type ID'lere göre -->
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a href="{{ route('admin.products.show', ['sort' => 'list']) }}"><i class="icon-sort-numeric-asc"></i> Sıralamaya Göre</a></li>
                        <li><a href="{{ route('admin.products.show', ['sort' => 'desc']) }}"><i class="icon-sort"></i> ID'ye göre</a></li>
                        <li><a href="{{ route('admin.products.show', ['sort' => 'active']) }}"><i class="icon-checkmark-circle"></i> Aktifler</a></li>
                        <li><a href="{{ route('admin.products.show', ['sort' => 'passive']) }}"><i class="icon-blocked"></i> Pasifler</a></li>
                        <li class="divider"></li>
                        <li><a href="{{ route('admin.products.show', ['sort' => 'all']) }}"><i class="icon-list-unordered"></i> Tümü</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    @endif
        ...
        <script>
            $(function () {
                $('.datatable-responsive').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'name', name: 'name', orderable: true, searchable: true, exportable: true},
                        {data: 'categories', name: 'category_id', orderable: true, searchable: true},
            ...
            $(".datatable-responsive").on("click", ".confirm-btn", function (e) {
                ...
                bootbox.confirm("(<strong>" + title + "</strong>) siliniyor. Onaylıyor musunuz ?", function (result) {
                    if (result == true) {
                        $.ajax({
                            url: url,
                            data: {_token: token},
            ...
            $(function () {
                ...
                $('#datatable-form').submit(function () {
                    ...
                    $.ajax({
                        url: '{{ route('admin.products.multiple') }}',
            ...
            @if(Session::has('sort') && Session::get('sort') == 'list')
                ...
                $("tbody").sortable({
                    opacity: 0.8, cursor: 'move', update: function () {
                        ...
                        $.get("{{ route('admin.products.show', ['sort' => 'sort']) }}", order, function (response) {

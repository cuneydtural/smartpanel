                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                <tr>
                                    <td class="headerContent">
                                        ...
                                        <img src="{{ url('/images/mailing_header.jpg') }}" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content00">
                                                        <h4 class="h4">Teşekkürler!</h4>
                                                        <p>Sayın <b>{{ @$data['name'] }};</b></p>
                                                        <p>Talebiniz alınmıştır. <br>En kısa sürede sizinle iletişime geçeceğiz. <br>Teşekkür eder, iyi günler dileriz.</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div mc:edit="std_footer">
                                                        <em>Copyright &copy; 2016 | İhlas Pazarlama A.Ş |  Tüm hakları saklıdır.</em>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" id="utility">
                                                    <div mc:edit="std_utility">
                                                        &nbsp;<a href="http//www.ihlaspazarlama.com.tr" target="_blank">Sitemizi ziyaret edin!</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
